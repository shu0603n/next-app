...
import TabPersonal from 'sections/apps/client/TabPersonal';
import TabAccount from 'sections/apps/client/TabAccount';
import TabPassword from 'sections/apps/client/TabPassword';
import TabRole from 'sections/apps/client/TabRole';
import TabSettings from 'sections/apps/client/TabSettings';
...
const EmployeeDetail = () => {
  ...
  const handleChange = (event: React.SyntheticEvent, newValue: string) => {
    setValue(newValue);
    router.push(`/client/${id}/${newValue}`);
  };
