...
import AddCustomer from 'sections/apps/parameter/job_category/AddCustomer';
import AlertCustomerDelete from 'sections/apps/parameter/job_category/AlertCustomerDelete';
...
// CustomerJobCategoryPageコンポーネント
const CustomerJobCategoryPage = () => {
...
CustomerJobCategoryPage.getLayout = function getLayout(page: ReactElement) {
  return <Layout>{page}</Layout>;
};

export default CustomerJobCategoryPage;
