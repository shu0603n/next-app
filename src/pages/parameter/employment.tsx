...
import AddCustomer from 'sections/apps/parameter/employment/AddCustomer';
import AlertCustomerDelete from 'sections/apps/parameter/employment/AlertCustomerDelete';
...
// CustomerEmploymentPageコンポーネント
const CustomerEmploymentPage = () => {
...
CustomerEmploymentPage.getLayout = function getLayout(page: ReactElement) {
  return <Layout>{page}</Layout>;
};

export default CustomerEmploymentPage;
