...
import AddCustomer from 'sections/apps/parameter/mail_account/AddCustomer';
import AlertCustomerDelete from 'sections/apps/parameter/mail_account/AlertCustomerDelete';
