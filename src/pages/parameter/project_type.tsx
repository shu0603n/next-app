...
import AddCustomer from 'sections/apps/parameter/project_type/AddCustomer';
import AlertCustomerDelete from 'sections/apps/parameter/project_type/AlertCustomerDelete';
...
async function fetchTableData() {
  try {
    const response = await fetch('/api/db/parameter/project_type/select');
    if (!response.ok) {
...
// CustomerProjectTypePageコンポーネント
const CustomerProjectTypePage = () => {
...
CustomerProjectTypePage.getLayout = function getLayout(page: ReactElement) {
  return <Layout>{page}</Layout>;
};

export default CustomerProjectTypePage;
