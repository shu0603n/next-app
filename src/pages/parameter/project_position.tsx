...
import AddCustomer from 'sections/apps/parameter/project_position/AddCustomer';
import AlertCustomerDelete from 'sections/apps/parameter/project_position/AlertCustomerDelete';
...
async function fetchTableData() {
  try {
    const response = await fetch('/api/db/parameter/project_position/select');
    if (!response.ok) {
