...
import AddCustomer from 'sections/apps/parameter/working/AddCustomer';
import AlertCustomerDelete from 'sections/apps/parameter/working/AlertCustomerDelete';
...
async function fetchTableData() {
  try {
    const response = await fetch('/api/db/parameter/working/select');
    if (!response.ok) {
...
// CustomerWorkingPageコンポーネント
const CustomerWorkingPage = () => {
...
CustomerWorkingPage.getLayout = function getLayout(page: ReactElement) {
  return <Layout>{page}</Layout>;
};

export default CustomerWorkingPage;
