...
// CustomerPositionPageコンポーネント
const CustomerPositionPage = () => {
...
CustomerPositionPage.getLayout = function getLayout(page: ReactElement) {
  return <Layout>{page}</Layout>;
};

export default CustomerPositionPage;
