...
import AlertCustomerDelete from 'sections/apps/engineer/AlertCustomerDelete';
...
const TabProfile = () => {
  ...
  const [data, setData] = useState<EngineerType>();
  const [allSkills, setAllSkills] = useState<any[]>();

  const [open, setOpen] = useState<boolean>(false);
  const [deleteOpen, setDeleteOpen] = useState<boolean>(false);

  const [editData, setEditData] = useState<EngineerType | null>(null);
