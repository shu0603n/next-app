...
import AddCustomer from 'sections/apps/engineer/skill-table/AddCustomer';
import CustomerView from 'sections/apps/engineer/skill-table/CustomerView';
import AlertCustomerDelete from 'sections/apps/engineer/skill-table/AlertCustomerDelete';
...
import { ClientType, SkillTableType } from 'types/engineer/skill-table';
