...
import AddCustomer from 'sections/apps/engineer/invoice-table/AddCustomer';
import CustomerView from 'sections/apps/engineer/invoice-table/CustomerView';
import AlertCustomerDelete from 'sections/apps/engineer/invoice-table/AlertCustomerDelete';
