...
import AddCustomer from 'sections/apps/employee/invoice-table/AddCustomer';
import CustomerView from 'sections/apps/employee/invoice-table/CustomerView';
import AlertCustomerDelete from 'sections/apps/employee/invoice-table/AlertCustomerDelete';
...
function ReactTable({ columns, data, renderRowSubComponent, handleAdd, getHeaderProps }: Props) {
  ...
  const sortBy = { id: 'project_name', desc: false };
